...
/* FIH_ADQ, 6360 { added by guorui*/
void max7302_set_backlight(struct msm_fb_data_type * mfd)
{

	__u32 bl_lel= mfd->bl_level;
	//printk(KERN_INFO "set_backlight %d\n",bl_lel);
...
int lcdc_device_register(struct msm_panel_info *pinfo)
{
	...
	lcdc_panel_data.set_backlight = max7302_set_backlight;
	/*} FIH_ADQ,  */
