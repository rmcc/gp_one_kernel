...
#define BT_SCO_SET_RTS_COUNT_OVERRIDE(flags)   ((flags) |= (1 << 3))
#define BT_SCO_GET_RTS_COUNT_OVERRIDE(flags)   (((flags) >> 3) & 0x1) 
...
typedef PREPACK struct {
    ...
    A_UINT32 scoOptFlags;               /* SCO Options Flags :
                                        ...
                                        */
	A_INT32 scoOptOffRssi;/*RSSI value below which we go to ps poll*/
	A_INT32 scoOptOnRssi; /*RSSI value above which we reenter opt mode*/
    A_UINT32 scoOptRtsCount;                                     
...
#define BT_A2DP_SET_RTS_COUNT_OVERRIDE(flags)   ((flags) |= (1 << 3))
#define BT_A2DP_GET_RTS_COUNT_OVERRIDE(flags)   (((flags) >> 3) & 0x1) 
...
typedef PREPACK struct {
	...
	A_INT32 a2dpOptOffRssi;/*RSSI value below which we go to ps poll*/
	A_INT32 a2dpOptOnRssi; /*RSSI value above which we reenter opt mode*/                                     
    A_UINT32 a2dpOptRtsCount;                                     
