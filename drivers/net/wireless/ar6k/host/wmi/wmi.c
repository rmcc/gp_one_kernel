...
A_STATUS wmi_cmd_send_xtnd(struct wmi_t *wmip, void *osbuf, WMI_COMMAND_ID cmdId,
...
static A_STATUS
wmi_simple_cmd(struct wmi_t *wmip, unsigned int cmdid)
{
    void *osbuf;
...
static A_STATUS
wmi_simple_cmd_xtnd(struct wmi_t *wmip, unsigned int cmdid)
{
    void *osbuf;
