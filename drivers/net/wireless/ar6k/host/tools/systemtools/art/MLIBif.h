...
#ident  "ACI $Id: //depot/sw/releases/olca2.1-RC/host/tools/systemtools/art/MLIBif.h#1 $, $Header: //depot/sw/releases/olca2.1-RC/host/tools/systemtools/art/MLIBif.h#1 $"
...
A_UINT32 OSmem32Read(A_UINT32 devNum, A_UINT32 regOffset);
void     OSmem32Write(A_UINT32 devNum, A_UINT32 regOffset, A_UINT32 regValue);
