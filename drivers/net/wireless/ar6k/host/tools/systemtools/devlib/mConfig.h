...
#ident  "ACI $Id: //depot/sw/releases/olca2.1-RC/host/tools/systemtools/devlib/mConfig.h#2 $, $Header: //depot/sw/releases/olca2.1-RC/host/tools/systemtools/devlib/mConfig.h#2 $"
...
typedef struct AR6002_txgain_tbl {
  A_UCHAR desired_gain ;
  A_UCHAR paout2gn;
  A_UCHAR padrvgn;
  A_UCHAR pabuf5gn;
