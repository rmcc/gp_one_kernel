...
#ident  "ACI $Id: //depot/sw/releases/olca2.1-RC/host/tools/systemtools/devlib/mdata.h#2 $, $Header: //depot/sw/releases/olca2.1-RC/host/tools/systemtools/devlib/mdata.h#2 $"
...
typedef struct mdkFalconDesc		/* Falcon WMAC Descr */
	...
	A_UINT32    hwExtraBuffer[5];	/* Extended for Falcon support */
	} MDK_FALCON_DESC;
