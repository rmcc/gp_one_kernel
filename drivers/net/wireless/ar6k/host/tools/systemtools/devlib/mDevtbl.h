...
#ident  "ACI $Id: //depot/sw/releases/olca2.1-RC/host/tools/systemtools/devlib/mDevtbl.h#1 $, $Header: //depot/sw/releases/olca2.1-RC/host/tools/systemtools/devlib/mDevtbl.h#1 $"
