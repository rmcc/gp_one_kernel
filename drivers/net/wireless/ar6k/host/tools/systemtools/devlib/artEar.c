...
#ident  "ACI $Id: //depot/sw/releases/olca2.1-RC/host/tools/systemtools/devlib/artEar.c#1 $, $Header: //depot/sw/releases/olca2.1-RC/host/tools/systemtools/devlib/artEar.c#1 $"
