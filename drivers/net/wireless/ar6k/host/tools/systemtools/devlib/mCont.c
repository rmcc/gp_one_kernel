...
#ident  "ACI $Id: //depot/sw/releases/olca2.1-RC/host/tools/systemtools/devlib/mCont.c#1 $, $Header: //depot/sw/releases/olca2.1-RC/host/tools/systemtools/devlib/mCont.c#1 $"
...
#elif defined(AR6002)
           writeField(devNum, "an_localmode", 0x1);
           writeField(devNum, "an_synthon", 0x1);
           writeField(devNum, "an_txon", 0x1);
           writeField(devNum, "an_paon", 0x1);
           writeField(devNum, "an_force_xpaon", 0x1);
#else
//#error "Unknown arch"
#endif
        }
...
#if defined(AR6002)
    //writeField(devNum, "an_force_xpaon", 0x0);
#endif
}
