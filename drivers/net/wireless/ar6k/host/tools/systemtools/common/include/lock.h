...
#ident  "ACI $Id: //depot/sw/releases/olca2.1-RC/host/tools/systemtools/common/include/lock.h#1 $, $Header: //depot/sw/releases/olca2.1-RC/host/tools/systemtools/common/include/lock.h#1 $"
