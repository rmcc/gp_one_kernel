...
#ident	"ACI $Id: //depot/sw/releases/olca2.1-RC/host/tools/systemtools/common/include/dk_cmds.h#1 $, $Header: //depot/sw/releases/olca2.1-RC/host/tools/systemtools/common/include/dk_cmds.h#1 $"
...
#if !defined(AR6000) && !defined(AR6K) 
...
#endif // ECOS
            struct __PAD{
                A_UINT8 bytes[2048]; // bytes to be pad 
            }PAD;

            struct __testCmd{
                A_UINT32 cmdLen; // bytes to be pad 
            }TEST_CMD;
