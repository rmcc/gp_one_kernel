 ...
 *
 */
static const char athId[] __attribute__ ((unused)) = "$Id: //depot/sw/releases/olca2.1-RC/host/tools/athbtfilter/bluez/abtfilt_utils.c#2 $";
...
INLINE A_STATUS
A_TASK_DELETE(A_TASK_HANDLE *handle)
{
    int ret;
