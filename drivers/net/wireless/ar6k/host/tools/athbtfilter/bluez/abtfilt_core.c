 ...
 *
 */
static const char athId[] __attribute__ ((unused)) = "$Id: //depot/sw/releases/olca2.1-RC/host/tools/athbtfilter/bluez/abtfilt_core.c#5 $";
...
{
    A_STATUS status;
    A_UCHAR buf[sizeof(WMI_SET_BT_PARAMS_CMD)]; //larger of the two
