...
bmiloader -i $NETIF --read --file=$before --length=32 --address=0x004f3020
...
bmiloader -i $NETIF --read --file=$before --length=64 --address=0x004f3040
...
bmiloader -i $NETIF --read --file=$after --length=128 --address=0x004f3000
