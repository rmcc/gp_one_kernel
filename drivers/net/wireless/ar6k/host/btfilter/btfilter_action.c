...
static const BT_CONTROL_ACTION_DESC_STATE g_ActionDefaults[ATH_BT_MAX_STATE_INDICATION] =
{
    ...
    /* ATH_BT_SCO     */      {{{ "-s 1 2",             0, NULL }, { "-pSCO 10 20 2 2 1 0 0 ; -s 1 1", 0, NULL }}},
    /* ATH_BT_ACL     */      {{{ ACTION_TODO_TBD,      0, NULL }, { ACTION_TODO_TBD,      0, NULL }}},
    /* ATH_BT_A2DP    */      {{{ "-s 2 2",             0, NULL }, { "-pA2DP 30 3 ; -s 2 1", 0, NULL }}},
    /* ATH_BT_ESCO    */      {{{ "-s 4 2",             0, NULL }, { "-pSCO 1 20 2 2 3 0 0 ; -s 4 1",0, NULL }}},
};
    ...
    switch (tag) {
        ...
        case BT_PARAM_SCO_TAG:
            ...
            pParamsCmd->info.scoParams.psPollLatencyFraction =
                                                    (A_UINT8)args[4];
            pParamsCmd->info.scoParams.noSCOSlots =  (A_UINT8)args[5];
            pParamsCmd->info.scoParams.noIdleSlots =  (A_UINT8)args[6];
            break;
