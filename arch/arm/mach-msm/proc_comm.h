...
typedef union
{
  ...
  {
    uint32_t check_flag;
    uint32_t cmd_parameter[SMEM_OEM_CMD_BUF_SIZE];
  }cmd_data;

  struct t_return_data
  {
    uint32_t check_flag;
    uint32_t return_value[SMEM_OEM_CMD_BUF_SIZE];
  }return_data;
...
typedef enum
{
  ...
  SMEM_PROC_COMM_OEM_UNLOCK_NAND_MPU,       /* ZEUS_CR_175  */
...
typedef enum {
  ...
  /*ZEUS_CR_250 START--Add a new NV No.8004 to implement the windows mobile image update mechanism for Host team*/
  NV_WINMO_IMAGE_UPDATE_FLAG_I   =8004,  
  /*ZEUS_CR_250 END*/

  /*ZEUS_CR_424 START--Add 20 NVs for audio volume, calibration, filter, and echo cancellation data*/
  NV_CMCS_PCM_AUDIO_HANDSET_CAL_I  =8005,
  NV_CMCS_PCM_AUDIO_HANDSET_EEC_I  =8006,
  NV_CMCS_PCM_AUDIO_HANDSET_IIR_I  =8007,
  NV_CMCS_PCM_AUDIO_HANDSET_VOL_I  =8008,
  NV_CMCS_PCM_AUDIO_HEADSET_CAL_I  =8009,
  NV_CMCS_PCM_AUDIO_HEADSET_EEC_I  =8010,
  NV_CMCS_PCM_AUDIO_HEADSET_IIR_I  =8011,
  NV_CMCS_PCM_AUDIO_HEADSET_VOL_I  =8012,
  NV_CMCS_PCM_AUDIO_SPEAKER_CAL_I  =8013,
  NV_CMCS_PCM_AUDIO_SPEAKER_EEC_I  =8014,
  NV_CMCS_PCM_AUDIO_SPEAKER_IIR_I  =8015,
  NV_CMCS_PCM_AUDIO_SPEAKER_VOL_I  =8016,
  NV_CMCS_PCM_AUDIO_BLUETOOTH_CAL_I  =8017,
  NV_CMCS_PCM_AUDIO_BLUETOOTH_EEC_I  =8018,
  NV_CMCS_PCM_AUDIO_BLUETOOTH_IIR_I  =8019,
  NV_CMCS_PCM_AUDIO_BLUETOOTH_VOL_I  =8020,
  NV_CMCS_PCM_AUDIO_CARKIT_CAL_I  =8021,
  NV_CMCS_PCM_AUDIO_CARKIT_EEC_I  =8022,
  NV_CMCS_PCM_AUDIO_CARKIT_IIR_I  =8023,
  NV_CMCS_PCM_AUDIO_CARKIT_VOL_I  =8024, 
  NV_BSP_ADB_USER_RIGHT_I  =8025,
  

  /*Modify the size of NV_MAX_I because add new NV Items*/
  NV_MAX_I                                       = 8026
  /*ZEUS_CR_1670#####################  END  ######################################*/
